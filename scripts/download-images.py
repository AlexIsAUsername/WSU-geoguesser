...
crawl_delay_seconds = 11

# https://www.wright.edu/files/vr/cecs/media/panorama_9F2A0B6B_B0C9_3166_41CE_6FCCA0D0F493_0/u/1/0_0.jpg?v=1617816729222
names = [
...
for name, loc in zip(names, locations):
    ...
    for d in directions:
        print("cur direction: ", d)
        img_data = requests.get(f"{base_url}{name}{d}").content
        time.sleep(crawl_delay_seconds)
        
        path_name = f'{loc}/{d[3]}.jpg'
        print(path_name)
        
        with open(path_name, 'wb') as handler:
